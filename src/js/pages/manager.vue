<template>
  ...
  @scroll="recylerScroll" @loadmore="loadmore" loadmoreoffset="300"
  >
...
export default {
    ...
    return {
      ...
      banner: {
        photos: [
          {
            src:
              "https://gw.alicdn.com/tps/TB1JyaCPFXXXXc9XXXXXXXXXXXX-140-140.jpg"
          },
          {
            src:
              "https://gw.alicdn.com/tps/TB1MwSFPFXXXXbdXXXXXXXXXXXX-140-140.jpg"
          },
          {
            src:
              "https://gw.alicdn.com/tps/TB1U8avPFXXXXaDXpXXXXXXXXXX-140-140.jpg"
          },
          {
            src:
              "https://gw.alicdn.com/tps/TB17Xh8PFXXXXbkaXXXXXXXXXXX-140-140.jpg"
          },
          {
            src:
              "https://gw.alicdn.com/tps/TB1cTmLPFXXXXXRXXXXXXXXXXXX-140-140.jpg"
          },
          {
            src:
  ...
  methods: {
    ...
    listenAppearAndDisappear: function() {
      this.stickyHeaderType =
        this.stickyHeaderType === "appear" ? "none" : "appear";
    },
    listenScrollEvent: function() {
      this.stickyHeaderType =
        this.stickyHeaderType === "scroll" ? "none" : "scroll";
    },
