package com.zkcloud.zkShop.service;
...
import com.zkcloud.zkShop.broadcast.NotifictionBroadcastReceiver;
import com.zkcloud.zkShop.constant.Constant;
import com.zkcloud.zkShop.extend.DownloadUtil;
        ...
        protected Integer doInBackground(Void... voids) {
            ...
            if (rightfile.exists()) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    uri = FileProvider.getUriForFile(WXEnvironment.sApplication, "com.zkcloud.zkShop.fileprovider",rightfile);
